/*
    ...
    floating-point operations for initial ease of implementation and
    verification of accuracy / viability of the solution.  A fixed-point
    version will be used for an actual implementation.
