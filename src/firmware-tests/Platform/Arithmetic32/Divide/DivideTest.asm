...
testAssert:
	...
	banksel carry
	.assert "carry == expectedCarry, 'Carry (overflow) expectation failure.'"
	.assert "digitCarry == expectedDigitCarry, 'Digit Carry (divide-by-zero) expectation failure.'"
