...
[>>>]
%
( This fixture can be cut into a piece of wood, true and at least 5mm thick, to hold the workpiece for 3-Spool.nc )
( Zero is the XY centre of the spool, with Z on top of the board )
