...
[>>>]
%
( Spoil Board of at least 2mm is required )
( Zero is the XY centre of the spool, with Z at 18mm above the spoil board )
( Facing assumes maximum stock height of 18mm )
